...
export class SimpleMath {
  ...
  constructor(options: Options) {
    this.openrpcDocument = simpleMathDoc;
  ...
  private request(methodName: string, params: any[]): Promise<any> {
   ...
   /* if (openRpcMethodValidationErrors && openRpcMethodValidationErrors !== []) {
      console.log(openRpcMethodValidationErrors);
